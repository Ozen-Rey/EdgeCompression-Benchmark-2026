"""
Calcolo qualità VVC — VERSIONE PRESET MULTIPLI.

Itera su preset NUOVI (faster, slow) — il preset originale (medium) è già
stato calcolato dalla v1.

Output:
  ~/tesi/results/video/vvenc_quality.csv (append, con colonna preset)
"""
...
from run_vvenc import VVENC_CRF_POINTS, PRESETS
...
def main():
    print("=" * 70)
    print(f"VVC QUALITY COMPUTATION — EXTRA PRESETS")
