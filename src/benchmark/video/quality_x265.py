"""
Calcolo qualità x265 — VERSIONE PRESET MULTIPLI.

Itera su preset NUOVI (faster, slow) — il preset originale (medium) è già
stato calcolato dalla v1.

Output:
  ~/tesi/results/video/x265_quality.csv (append, con colonna preset)
"""
...
def main():
    print("=" * 70)
    print(f"x265 QUALITY COMPUTATION — EXTRA PRESETS")
